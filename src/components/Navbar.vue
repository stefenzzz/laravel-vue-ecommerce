<script setup>
import {Bars3Icon, UserIcon, ArrowRightStartOnRectangleIcon} from '@heroicons/vue/24/outline'; 
...
onMounted(()=> useAuthStore().getUser());

</script>

<template>
    
  <header class="flex justify-between items-center pl-3 pr-6 h-14 shadow bg-white z-10 relative">
    ...
    <Menu as="div" class="relative inline-block text-left hover:opacity-80">
